...
struct qt_meta_stringdata_CLASSEraserENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSEraserENDCLASS = QtMocHelpers::stringData(
    "Eraser",
    "removeRandomAgent",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSEraserENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Eraser::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSEraserENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSEraserENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSEraserENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Eraser, std::true_type>,
        // method 'removeRandomAgent'
...
void Eraser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->removeRandomAgent(); break;
        default: ;
        }
    }
    (void)_a;
...
void *Eraser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSEraserENDCLASS.stringdata0))
