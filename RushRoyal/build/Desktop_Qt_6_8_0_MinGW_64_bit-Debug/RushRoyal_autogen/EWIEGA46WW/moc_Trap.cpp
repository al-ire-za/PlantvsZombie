...
struct qt_meta_stringdata_CLASSTrapENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSTrapENDCLASS = QtMocHelpers::stringData(
    "Trap",
    "removeEnemies",
    "",
    "QList<Enemy*>",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTrapENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Trap::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSTrapENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTrapENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTrapENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void Trap::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Trap::*)(const QVector<Enemy*> & );
            if (_t _q_method = &Trap::removeEnemies; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Trap::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTrapENDCLASS.stringdata0))
