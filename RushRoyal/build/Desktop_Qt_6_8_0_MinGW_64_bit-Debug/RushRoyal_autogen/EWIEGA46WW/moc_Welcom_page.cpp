...
struct qt_meta_stringdata_CLASSwelcom_pageENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSwelcom_pageENDCLASS = QtMocHelpers::stringData(
    "welcom_page",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSwelcom_pageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject welcom_page::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSwelcom_pageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSwelcom_pageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSwelcom_pageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *welcom_page::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSwelcom_pageENDCLASS.stringdata0))
