...
struct qt_meta_stringdata_CLASSRunnerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSRunnerENDCLASS = QtMocHelpers::stringData(
    "Runner"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSRunnerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Runner::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSRunnerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSRunnerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSRunnerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Runner, std::true_type>
    >,
    nullptr
} };
...
void *Runner::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSRunnerENDCLASS.stringdata0))
